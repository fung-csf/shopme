...
public class CountryRestControllerTests {
	...
	/*
	 * security configuration in WebSecurityConfig requires user to be authenticated
	 * can use arbitrary values for user data, but ensure the correct role is used.
	 */
	@Test
