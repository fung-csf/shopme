...
public class UserController {
	...
	public String listFirstPage() {
		...
		// NOTE: these are the default values for path variable and URL parameters
	...
	// using @RequestParam, we can get the image file input, the input has the
	// property name="image"
	...
	private String getRedirectURLtoAffectedUser(User user) {
		...
		// after user is saved display the user instead of the entire user list
		// email is a unique field to identify each user.
